...
products = {'HP 8300 Elite Small Form Factor Desktop Computer', 'HP 22-b016 All-in-One desktop', 'HP Pavilion Power 580-023w Gaming Tower', 'Aspire E 15-inch notebook', 'HP 14 Inch "Stream" Laptop',' Dell OptiPlex, Intel Core 2 Duo'};
price = [500, 450, 750, 600, 220, 480];
quantity_2017 = [150000, 120000, 100000, 180000, 200000, 110000];
